...
describe('NodeReportView.js spec', function() {
    ...
    describe('view is constructed', function() {
        it('should exist', function() {
            ...
            expect($(this.testView.el).text()).to.equal('power-of-greyskullServicesReportsEventsDetailsLogs Service Status Report UtilizationCPU UsageMemory UsageNetwork Usage Reports Available Reports list loading or not available Report DataSelecting a report from the dropdown above will populate this area with the report results.  Events Report102550100 records per pageSearch:Processing...CreatedEvent TypeMessage  Resource DetailsNo additional details available Log Analysis×CloseLog Severity FiltersUncheck log-type to hide from displayExitLog Events Search Results102550100 records per pageSearch:Processing...TimestampSyslog SeverityComponentHostMessage');
        });
        it('should exist', function() {
