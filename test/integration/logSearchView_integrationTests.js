...
describe('logSearchView.js spec', function() {
    ...
    describe('view is constructed', function() {
        it('should exist', function() {
            ...
            expect($(this.testView.el).text()).to.equal(' Log Analysis×CloseLog Severity FiltersUncheck log-type to hide from displayExitLog Events Log Analysis Search Results102550100 records per pageSearch:Processing...TimestampLevelComponentHostMessage');
        });
