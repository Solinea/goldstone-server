...
describe('logSearchView.js spec', function() {
    ...
    describe('view is constructed', function() {
        it('should exist', function() {
            ...
            expect($(this.testView.el).text()).to.include('Log BrowserEvent BrowserAPI BrowserLogs vs TimePredefined Searches  Log Events×CloseLog Severity FiltersUncheck log-type to hide from displayExitLog Browser102550100 records per pageSearch:TimestampSyslog SeverityComponentHostMessage');
        });
