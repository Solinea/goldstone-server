...
describe('apiPerfReportView.js spec', function() {
    beforeEach(function() {
        ...
        goldstone.i18nJSON = {"English":{"domain":"messages","locale_data":{"messages":{"":{"domain":"messages","plural_forms":"nplurals=2; plural=(n != 1);","lang":"en"},"Nova API Performance":[""],"Neutron API Performance":[""],"Keystone API Performance":[""],"Glance API Performance":[""],"Cinder API Performance":[""],"API Call":[""],"All":[""],"Start":[""],"End":[""],"Interval":[""],"User Settings":[""],"Language":["def"],"goldstone":[""]}}},"japanese":{"domain":"messages","locale_data":{"messages":{"":{"domain":"messages","plural_forms":"nplurals=1; plural=0;","lang":"ja"},"goldstone":["ゴールドストーン"],"Metrics":["メトリック"],"User Settings":["ユーザ設定"],"Nova API Performance":["新星のAPIのパフォーマンス"],"Neutron API Performance":["中性子のAPIパフォーマンス"],"Keystone API Performance":["キーストーンのAPIパフォーマンス"],"Glance API Performance":["キーストーンのAPIパフォーマンス"],"Cinder API Performance":["シンダーAPIパフォーマンス"],"Language":["abc"],"API Call":["API呼び出し"],"All":["凡ゆる"],"Start":["始まり"],"End":["終わり"],"Interval":["インターバル"]}}}};
