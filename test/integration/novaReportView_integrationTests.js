...
describe('NovaReportView.js spec', function() {
    ...
    describe('view is constructed', function() {
        it('should exist', function() {
            ...
            expect($(this.testView.el).text()).to.equal(' Nova API PerformanceResponse Time (ms) VM SpawnsSpawn Events CPU ResourcesCores Memory ResourcesGB Disk ResourcesGB');
        });
