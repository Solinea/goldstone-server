...
describe('diskResourceView.js spec', function() {
    beforeEach(function() {
        ...
        this.testCollection = new DiskResourceCollection({
    ...
    describe('view is constructed', function() {
        ...
        it('can handle a null server payload and append appropriate response', function() {
            ...
            expect($('g').find('text').text()).to.equal('10:21:15:30:450102030405060708090TotalUsed');
