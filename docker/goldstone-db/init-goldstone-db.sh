...
gosu postgres 'export PGDATA=/var/lib/postgresql/data;/usr/lib/postgresql/9.4/bin/pg_ctl reload'

# reload exits immediately.  we want to wait for the server to be back before proceeding. 
