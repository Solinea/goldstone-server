...
class CoreResourceTypes(Setup):
    ...
    def test_mix(self):
        ...
        EXPECTED = [{u'name': u'Host',
                    ...
                    {u'name': u'LB Virtual IP',
                     u'integration': u'Neutron',
                     u'present': False,
                     u'unique_id': u"<class 'goldstone.core.models.LBVIP'>"},
                    {u'name': u'Floating IP address',
                     u'integration': u'Neutron',
                     u'present': False,
                     u'unique_id':
                    ...
                    {u'name': u'Metering Label',
                     u'integration': u'Neutron',
                     u'present': False,
                     u'unique_id':
                     u"<class 'goldstone.core.models.MeteringLabel'>"},
                    {u'name': u'Metering Label Rule',
                     u'integration': u'Neutron',
                     u'present': False,
                     u'unique_id':
        ...
        for entry in resource.types.graph.nodes():
            try:
                ...
                print "? %s doesn't have name or integration, exception: %s" \
                    % \
                    (entry, exc.message)
                bad = True
